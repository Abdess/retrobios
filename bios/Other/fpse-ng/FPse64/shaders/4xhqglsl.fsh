...
void main()
{
  vec3 c  = texture2D(uTex, v_texcoord0.xy).xyz;
  vec3 i1 = texture2D(uTex, v_texcoord1.xy).xyz; 
  vec3 i2 = texture2D(uTex, v_texcoord2.xy).xyz; 
  vec3 i3 = texture2D(uTex, v_texcoord3.xy).xyz; 
  vec3 i4 = texture2D(uTex, v_texcoord4.xy).xyz; 
  vec3 o1 = texture2D(uTex, v_texcoord5.xy).xyz; 
  vec3 o3 = texture2D(uTex, v_texcoord6.xy).xyz; 
  vec3 o2 = texture2D(uTex, v_texcoord5.zw).xyz;
  vec3 o4 = texture2D(uTex, v_texcoord6.zw).xyz; 
