...
void main()
{
  vec3 c10 = texture2D(uTex, v_texcoord1.xy).xyz; 
  vec3 c01 = texture2D(uTex, v_texcoord4.xy).xyz; 
  vec3 c11 = texture2D(uTex, v_texcoord0.xy).xyz; 
  vec3 c21 = texture2D(uTex, v_texcoord5.xy).xyz; 
  vec3 c12 = texture2D(uTex, v_texcoord2.xy).xyz; 
