...
- **12 files** the platforms' emulators load are not in the collection yet, named in the [gap analysis](https://abdess.github.io/retrobios/gaps/)
...
- **7,851 files**, each with its SHA1, MD5, SHA256, CRC32 and Adler-32 fingerprints: 2,496 system files, 2,816 arcade ROM sets, 2,539 game and engine data files
- **531 of 2,496 system files** matched to dump-preservation catalogs (No-Intro, Redump, TOSEC); arcade sets and engine data fall outside what those catalogs index
...
|----------|-----------------:|-------------------------:|------------|
| Batocera | 353/353 | 1,280/1,292 | MD5 hash |
...
| RetroBat | 341/341 | 923/934 | MD5 hash |
...
*Auto-generated on 2026-08-10T13:03:27Z*
